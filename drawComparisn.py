...
def main():
    ...
    while True:
        ...
        if ids is not None:
            ...
            if r_glob is not None and t_glob is not None:
                ...
                if not marker_was_visible:  # Marker just reappeared, start new path segments
    ...
    if plot_pen_tip and pen_tip_path_filtered_segments[0]:
        ...
        # --- Draw Pen Paths with an offset for comparison ---
        ...
        for segment in pen_tip_path_filtered_segments:
            # Apply offset to each point in the segment
        ...
        # Add a legend
        cv2.putText(final_canvas, 'Comparison', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
        cv2.putText(final_canvas, 'Origin (Red)', (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        cv2.putText(final_canvas, 'Raw Pen Tip (Green)', (10, 85), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(final_canvas, 'Filtered Pen Tip (Blue)', (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
